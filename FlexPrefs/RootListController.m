...
#define TWEAK_IDENTIFIER @"com.todayios-cydia.flexloader"
#define PREFS_CHANGED_NN @"com.todayios-cydia.flexloader.prefschanged"
...
-(void)viewDidLoad{
    ...
    UIImage *headerImage = [[UIImage alloc]
                            initWithContentsOfFile:[[NSBundle bundleWithPath:@"/Library/PreferenceBundles/FlexPrefs.bundle"] pathForResource:@"XCode@3x" ofType:@"png"]];
    ...
    [headerLabel setText:@"FLEXLoader"];
...
- (NSArray *)specifiers {
    if (!_specifiers) {
        ...
        [twitterSpec setProperty:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/FlexPrefs.bundle/Twitter.png"] forKey:@"iconImage"];
...
-(void)_reallyRespring{
    NSURL *relaunchURL = [NSURL URLWithString:@"prefs:root=FLEXLoader"];
